      ...
      <div className="container mx-auto p-4">
        ...
        <div className="flex justify-center items-center gap-4 my-6">
          <Link href="/crypto/favorites">
            <Button className="bg-gray-800 hover:bg-purple-700 text-white border border-purple-500/30 px-6 py-6 rounded-lg transition-all duration-300 shadow-md hover:shadow-purple-500/20">
              My Favorites
            </Button>
          </Link>
